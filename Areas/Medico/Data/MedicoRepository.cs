...
INNER JOIN General.Usuario Us 
	...
	where med_esp.descripcion not in('TECNICA EN ENFERMERIA','CARDIOLOGIA','CIRUGIA CARDIOVASCULAR','CIRUGIA GENERAL','DIMPLOMATURA EN AUDITORIA MEDICA','ENDOCRINOLOGIA',
